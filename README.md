...
🔟 设计师精调 → 插件导出 → 回写 business/ 规范稿
       ↓
1️⃣1️⃣ 候选池决策（每周一 11:00 飞书提醒）
```

---

**1️⃣ 产品经理 描述需求** `角色：产品经理`
...
同时规划页面间跳转关系，为写 `figma-config.json` 做准备。此步骤无需 产品经理 干预。

---

**4️⃣ 创建需求文件夹** `角色：AI 或开发`
...
**5️⃣ 搭建 HTML 原型** `角色：AI`

AI 从 `business/{module}/` 复制规范 HTML 作为起点，按需求修改后输出至需求文件夹。产品经理 无需操作，等待预览链接即可。

---

**6️⃣ 编写 `figma-config.json`** `角色：AI`
...
**8️⃣ 确认交付 → 文件夹冻结存档** `角色：产品经理`

话术建议：

> 「这版 OK 了，可以交付」

产品经理 确认后该文件夹不再修改，下一期迭代新建 v2 文件夹。

---

**9️⃣ 同步到 Figma** `角色：AI 或开发`
...
**1️⃣1️⃣ 候选池决策** `角色：收口人`  每周一 11:00 飞书提醒
